...
| **BinaryTree**                 | Ett exempel på ett rekursivt binärt träd som kan utföra operationerna Inorder, Preorder och Postorder.                                                                                                                                                                                          |
...
| **CustomExceptionExample**     | En egen exceptionklass i Java som vi kan använda för att signallera att saker går fel i ett program. Ett custom exception ärver från basklassen Exception och är egentligen bara en wrapper som delegerar meddelanden till sin superklass.                                                      |
| **LambdaExample**              | Kodexempel som visar hur anonyma metoder (så kallade lambda) fungerar och varför de är användbara i Java (kopplat till föreläsning 9).                                                                                                                                                          |
...
| **GreedyCoinChange**           | En girig myntväxlaralgoritm som alltid väljer den största möjliga valören först när den ska ge tillbaka växelpengar.                                                                                                                                                                            |
...
| **StreamExample**              | Hur vi kan arbeta med en stream-pipeline i Java för att skapa komplexa kedjor med "filter" för data (kopplat till föreläsning 9).                                                                                                                                                               |
